var Transform = require('stream').Transform,
    LCClientNormal = require('../clients/normal/lib/lc-client.js'),
    LCClientFilter = require('../clients/filter/lib/lc-client.js'),
...
function ExecuteQueryMixTransform (options) {
  ...
  this.T0 = new Date();
  if (options.type == "lc-filter") {
    this.options = {
      client : new LCClientFilter(
